...
class Acfe_Ninja_Forms_Style extends Widget_Base {

	public function get_name() {
		return 'acfe-ninja-forms';
	}

	public function get_title() {
		return esc_html__( 'IE Ninja Forms', 'all-elementor-forms' );
	}
   ...
   public function get_categories() {
	...
	protected function _register_controls() {
  		...
  		$this->start_controls_section(
  			'acfe_section_ninja_form',
  			[
  				'label' => esc_html__( 'NInja Forms', 'all-elementor-forms' )
  			]
  		);
		...
		$this->add_control(
			'acfe_ninja_form',
			[
				'label' => esc_html__( 'Select your ninja form', 'all-elementor-forms' ),
				'label_block' => true,
				'type' => Controls_Manager::SELECT,
				'options' => eaiocf_select_ninja_form(),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-text, {{WRAPPER}} .acfe-contact-form-container textarea.ninja-textarea' => 'background: {{VALUE}};',
				],
			]
		);
  		...
  		$this->add_responsive_control(
  			...
  			[
				...
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-text' => 'width: {{SIZE}}{{UNIT}};',
				],
  			]
  		);
  		...
  		$this->add_responsive_control(
  			...
  			[
				...
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container textarea.ninja-textarea' => 'width: {{SIZE}}{{UNIT}};',
				],
  			]
  		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-text, {{WRAPPER}} .acfe-contact-form-container textarea.ninja-textarea' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-text, {{WRAPPER}} .acfe-contact-form-container textarea.ninja-textarea' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .acfe-contact-form-container input.ninja-text, {{WRAPPER}} .acfe-contact-form-container textarea.ninja-textarea',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .acfe-contact-form-container input.ninja-text:focus, {{WRAPPER}} .acfe-contact-form-container textarea.ninja-textarea:focus',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'body {{WRAPPER}} .acfe-contact-form-container input.ninja-text:focus, body {{WRAPPER}} .acfe-contact-form-container textarea.ninja-textarea:focus' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container, {{WRAPPER}} .acfe-contact-form-container .ninja-form label' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-text, {{WRAPPER}} .acfe-contact-form-container textarea.ninja-textarea' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .acfe-contact-form-container, {{WRAPPER}} .acfe-contact-form-container .ninja-form label',
			]
		);
		...
		$this->start_controls_section(
  		...
  		$this->add_responsive_control(
  			...
  			[
				...
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-submit' => 'width: {{SIZE}}{{UNIT}};',
				],
  			]
  		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .acfe-contact-form-container input.ninja-submit',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-submit' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-submit' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-submit' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-submit' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-submit' => 'border-radius: {{SIZE}}px;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-submit:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .acfe-contact-form-container input.ninja-submit:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	<?php if ( ! empty( $settings['acfe_ninja_form'] ) ) : ?>
		<div class="acfe-contact-form-container">
			<?php echo do_shortcode( '[ninja_form id="' . $settings['acfe_ninja_form'] . '" ]' ); ?>
		</div>
	<?php endif; ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Acfe_Ninja_Forms_Style() );